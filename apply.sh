...
runCmd "mkdir /home/$userName/.vim /home/$userName/.vim/tmp; mkdir -p /home/$userName/.vim/autoload /home/$userName/.vim/bundle && curl -LSso /home/$userName/.vim/autoload/pathogen.vim https://tpo.pe/pathogen.vim"
fin "SUCCESS"
printf "Installing emmet for vim... "
runCmd "cd /home/$userName/.vim/bundle; git clone https://github.com/mattn/emmet-vim.git"
fin "SUCCESS"
printf "Installing nerdtree for vim... "
runCmd "cd /home/$userName/.vim/bundle; git clone https://github.com/scrooloose/nerdtree.git"
fin "SUCCESS"
printf "Installing auto-pairs for vim... "
runCmd "cd /home/$userName/.vim/bundle; git clone https://github.com/jiangmiao/auto-pairs.git"
fin "SUCCESS"
...
runCmd "git clone https://github.com/tmux-plugins/tpm /home/$userName/.tmux/plugins/tpm"
fin "SUCCESS"
printf "Copying dotfiles... "
runCmd "cp tmux.conf /home/$userName/.tmux.conf"
runCmd "cp bashrc /home/$userName/.bashrc"
runCmd "cp vimrc /home/$userName/.vimrc"
fin "SUCCESS"
